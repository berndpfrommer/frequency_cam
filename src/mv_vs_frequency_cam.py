...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='compare Metavision SDK vs frequency cam.')
    parser.add_argument(
        '--bag',
        '-b',
        action='store',
    ...
    parser.add_argument(
        '--diff_thresh', help='MV time period diff thresh (usec)', default=100, type=int
    )
    parser.add_argument(
        '--filter_length',
    ...
    parser.add_argument('--output_dir', help='name of output directory', default='mv_fc_frames')
    parser.add_argument(
        '--log_scale',
        action='store_true',
        required=False,
        help='color frequency on log scale',
    )
    ...
    parser.add_argument(
        ...
        required=False,
        type=int,
        help='x-coordinate of debug pixel',
        default=-1,
    )
    parser.add_argument(
        '--debug_y',
        required=False,
        type=int,
        help='y-coordinate of debug pixel',
        default=-1,
    )
    parser.add_argument(
        '--timeout_cycles',
    ...
    fc_algo = frequency_cam.FrequencyCam(
        width=res[0],
        height=res[1],
        min_freq=args.freq_min,
        max_freq=args.freq_max,
